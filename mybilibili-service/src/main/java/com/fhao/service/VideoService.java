...
import com.fhao.dao.VideoDao;
import com.fhao.domain.*;
import com.fhao.domain.exception.ConditionException;
import com.fhao.service.util.FastDFSUtil;
import com.fhao.service.util.ImageUtil;
import com.fhao.service.util.IpUtil;
...
//
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
         com.fhao.domain.File file = fileService.getFileByMd5(fileMd5);
